...
func (app *application) home(w http.ResponseWriter, r *http.Request) {
    ...
    app.render(w, r, http.StatusAccepted, "home.tmpl", data)
}
...
func (app *application) snippetView(w http.ResponseWriter, r *http.Request) {
    ...
    data.Snippet= snippet
        ...
        app.render(w, r, http.StatusAccepted, "view.tmpl", data)
    }
...
func (app *application) snippetCreate(w http.ResponseWriter, r *http.Request) {
    ...
    app.render(w, r, http.StatusAccepted, "create.tmpl", data)
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
    ...
    form.CheckField(validator.MinChars(form.Password, 8), "password", "Password must be minimum 8 characters long")
